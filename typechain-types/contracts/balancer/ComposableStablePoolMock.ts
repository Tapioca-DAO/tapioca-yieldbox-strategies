...
export interface ComposableStablePoolMockInterface extends utils.Interface {
  functions: {
...
export interface ComposableStablePoolMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ComposableStablePoolMockInterface;
