...
export interface IGmxRewardDistributorInterface extends utils.Interface {
  functions: {
...
export interface IGmxRewardDistributor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IGmxRewardDistributorInterface;
