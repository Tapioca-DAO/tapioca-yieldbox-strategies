...
export interface BaseNativeStrategyInterface extends utils.Interface {
  functions: {
...
export interface BaseNativeStrategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseNativeStrategyInterface;
