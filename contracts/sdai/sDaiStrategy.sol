...
//For mainnet
contract sDaiStrategy is BaseERC20Strategy, BoringOwnable, ReentrancyGuard {
    ...
    function _currentBalance() internal view override returns (uint256 amount) {
        ...
        return queued + previewRedeem; //this operation is valid because dai <> tDai ratio is 1:1
    }
    ...
    function _withdraw(
        ...
        require(
            IERC20(contractAddress).balanceOf(address(this)) + maxWithdraw >=
                amount,
            "sDai: not enough"
        ); // dai <> tDai is 1:1

        uint256 toWithdraw = maxWithdraw >= amount ? amount : maxWithdraw;
