...
*When the amount of tokens is greater than the threshold, a deposit operation is performed*
...
```solidity
function sDai() external view returns (contract ISavingsDai)
```
...
| Name | Type | Description |
|---|---|---|
| _0 | contract ISavingsDai | undefined |
